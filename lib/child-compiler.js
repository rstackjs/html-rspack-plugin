...
/**
 * @file
 * This file uses Rspack to compile a template with a child compiler.
 *
 * [TEMPLATE] -> [JAVASCRIPT]
 *
 */

/** @typedef {import("@rspack/core").Chunk} Chunk */
/** @typedef {import("@rspack/core").sources.Source} Source */
/** @typedef {{hash: string, entry: Chunk, content: string, assets: {[name: string]: { source: Source, info: import("@rspack/core").AssetInfo }}}} ChildCompilationTemplateResult */
...
class HtmlWebpackChildCompiler {
  /** @type {Promise<{[templatePath: string]: ChildCompilationTemplateResult}> | undefined} */
  compilationPromise;
   ...
   *
   * @param {import('@rspack/core').Compilation} mainCompilation
  ...
  compileTemplates(mainCompilation) {
    ...
    const temporaryTemplateNames = this.templates.map(
      (template, index) => `__child-HtmlRspackPlugin_${index}-${template}`,
    );
    ...
    this.compilationPromise = new Promise((resolve, reject) => {
      ...
      childCompiler.runAsChild((err, entries, childCompilation) => {
        ...
        /** @type {{[name: string]: { source: Source, info: import("@rspack/core").AssetInfo }}} */
        const assets = {};
